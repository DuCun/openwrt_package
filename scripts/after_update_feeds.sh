# 执行脚本的目录在openwrt
## 更换n2n版本
rm -rf package/feeds/packages/n2n/patches
sed -i 's/PKG_VERSION:=3.0/PKG_VERSION:=3.1.1/g' package/feeds/packages/n2n/Makefile
sed -i 's/^PKG_HASH:.*/PKG_HASH:=skip/g' package/feeds/packages/n2n/Makefile
# 以下是超頻
